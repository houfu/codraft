...
Codraft is a document assembly tool built on [Claude Cowork](https://claude.com/product/cowork). It is similar to traditional document automation platforms — [docassemble](https://docassemble.org/)(which this project takes a lot of inspiration from), HotDocs, Documate — but approaches the process using AI first. The result is a tool that is much simpler: a conversational interview driven by Claude, producing completed documents from plain templates.
