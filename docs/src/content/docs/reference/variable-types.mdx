...
Variables in CoQuill have a type that controls how Claude asks for the value during the interview. Types are either inferred automatically from the variable name, or declared explicitly in `config.yaml`.
