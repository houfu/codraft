...
**Claude Cowork** -- Download the latest `coquill-v*.zip` from [GitHub Releases](https://github.com/houfu/coquill/releases), unzip it, and open the folder as a new Cowork project. Done.
